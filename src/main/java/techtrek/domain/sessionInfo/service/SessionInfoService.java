...
public class SessionInfoService {
    ...
    // 꼬리 질문 생성하기
    public SessionInfoResponse.NewQuestion createTailInterview(String sessionId, String parentFieldId) {
       return createTailInterviewBean.exec(sessionId,parentFieldId);
    }
