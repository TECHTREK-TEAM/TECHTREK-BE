...
//            String totalCount = data.get("totalQuestionNumber").toString();
//
...
//            }
//
//            response.add(new SessionParserResponse.ListData(question, answer, questionNumber, totalCount));
//        }
//
//        // totalQuestionNumber 기준 오름차순 정렬
//        response.sort(Comparator.comparingInt(data -> Integer.parseInt(data.getTotalCount())));
//
//        return response;
//    }
//}
