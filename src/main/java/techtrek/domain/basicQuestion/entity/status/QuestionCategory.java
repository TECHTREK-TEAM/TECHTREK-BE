...
public enum QuestionCategory {
    ...
    네트워크(new String[]{"tcp", "http", "dns", "cdn", "프록시", "nat", "포트", "소켓", "qos", "arp", "흐름제어", "혼잡제어", "윈도우", "트래픽", "스케일링", "msa", "이벤트", "api최적화"}),
    컴퓨터구조(new String[]{"캐시", "파이프라인", "isa", "레지스터", "인터럽트", "사이클", "메모리", "cpu스케줄"}),
    운영체제(new String[]{"프로세스", "스레드", "컨텍스트", "스케줄링", "동기화", "세마포어", "가상메모리", "페이징", "스와핑", "시스템콜", "교착상태", "장애복구"});

    private final String[] keywords;

    QuestionCategory(String[] keywords) {
